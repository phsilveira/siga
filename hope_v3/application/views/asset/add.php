<?php echo form_open('asset/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="acquired_at" value="<?php echo $this->input->post('acquired_at'); ?>" class="form-control" id="acquired_at" />
		</div>
	</div>
	<div class="form-group">

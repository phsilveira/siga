<?php echo form_open('assignment/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="start_at" value="<?php echo $this->input->post('start_at'); ?>" class="form-control" id="start_at" />
		</div>
	</div>
	<div class="form-group">
		<label for="end_at" class="col-md-4 control-label">End At</label>
		<div class="col-md-8">
			<input type="text" name="end_at" value="<?php echo $this->input->post('end_at'); ?>" class="form-control" id="end_at" />
		</div>
	</div>
	<div class="form-group">
		<label for="answer_at" class="col-md-4 control-label">Answer At</label>
		<div class="col-md-8">
			<input type="text" name="answer_at" value="<?php echo $this->input->post('answer_at'); ?>" class="form-control" id="answer_at" />
		</div>
	</div>
	<div class="form-group">
		<label for="scheduled_at" class="col-md-4 control-label">Scheduled At</label>
		<div class="col-md-8">
			<input type="text" name="scheduled_at" value="<?php echo $this->input->post('scheduled_at'); ?>" class="form-control" id="scheduled_at" />
		</div>
	</div>
	<div class="form-group">

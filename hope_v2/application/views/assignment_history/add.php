    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Assignment History Add</h3>
            </div>
            <?php echo form_open('assignment_history/add'); ?>
          	<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="assignment_id" class="form-control">
								...
								{
									$selected = ($assignment['id'] == $this->input->post('assignment_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="person_id" class="form-control">
								...
								{
									$selected = ($membership['id'] == $this->input->post('person_id')) ? ' selected="selected"' : "";
